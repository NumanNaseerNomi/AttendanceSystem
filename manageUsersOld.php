	...
	.then((respondedJsonData) =>
	{
		...
		for (let i = 0; i < respondedJsonData.length; i++)
		{
			...
			let dataConfig =
			{
				...
				aboutUser 	: respondedJsonData[i].about,
				manage 		: '<button type="button" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></button><button type="button" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button>'
			};
